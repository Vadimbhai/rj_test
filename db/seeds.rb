...
Comment.create(user: 1, text: %{Но император улыбнулся и перебил его:
— Сколько миль?
...
Comment.create(user: 1, text: %{Император перебил его:
...
Comment.create(user: 1, text: %{Болконский пожал плечами.
...
Comment.create(user: 1, text: %{— Полноте шутить, — сказал он.
...
Comment.create(user: 1, text: %{— C'est trahison peut-etre 6, — сказал князь Андрей, живо воображая себе серые шинели, раны, пороховой дым, звуки пальбы и славу, которая ожидает его.
...
Comment.create(user: 1, text: %{Собранные до тех пор складки на лбу быстро распустились в знак удовольствия, и он, слегка улыбаясь, стал рассматривать свои ногти.
...
Comment.create(user: 2, text: %{— Нисколько, — сказал князь Андрей.
...
Comment.create(user: 2, text: %{— Перестаньте шутить, Билибин, — сказал Болконский.
...
Comment.create(user: 3, text: %{В ту же ночь, откланявшись военному министру, Болконский ехал к армии, сам не зная, где он найдет ее, и опасаясь по дороге к Кремсу быть перехваченным французами.
...
Comment.create(user: 3, text: %{Князь Андрей видел, что офицер находился в том пьяном припадке беспричинного бешенства, в котором люди не помнят, что говорят. Он видел, что его заступничество за лекарскую жену в кибиточке исполнено того, чего он боялся больше всего в мире, того, что называется ridicule 3, но инстинкт его говорил другое. Не успел офицер договорить последних слов, как князь Андрей с изуродованным от бешенства лицом подъехал к нему и поднял нагайку:})
Comment.create(user: 4, text: %{— Где главнокомандующий? — спросил Болконский.
...
Comment.create(user: 5, text: %{Пройдя мимо экипажа Кутузова, верховых замученных лошадей свиты и казаков, громко говоривших между собою, князь Андрей вошел в сени. Сам Кутузов, как сказали князю Андрею, находился в избе с князем Багратионом и Вейротером. Вейротер был австрийский генерал, заменивший убитого Шмита. В сенях маленький Козловский сидел на корточках перед писарем. Писарь на перевернутой кадушке, заворотив обшлага мундира, поспешно писал. Лицо Козловского было измученное — он, видно, тоже не спал ночь. Он взглянул на князя Андрея и даже не кивнул ему головой.
...
Comment.create(user: 5, text: %{Лицо Кутузова неожиданно смягчилось, и слезы показались в его глазах. Он притянул к себе левою рукой Багратиона, а правою, на которой было кольцо, видимо, привычным жестом перекрестил его и подставил ему пухлую щеку, вместо которой Багратион поцеловал его в шею.
